    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Offline changes waiting to upload</p>
        </div>
        <span className={`rounded-full px-3 py-1 text-xs font-semibold ${online ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
